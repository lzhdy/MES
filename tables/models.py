...
class BatteryMark(Base):
    __tablename__ = 'battery_mark'
    __table_args__ = {'comment': '电芯标记表'}

    bar_code = Column(String(24), primary_key=True, comment='电芯条码')
    mark = Column(VARCHAR(255), comment='标记')
...
class C302(Base):
    ...
    P006 = Column(Float(8), comment='化成工步起始电压')
    P007 = Column(Float(8), comment='化成工步结束电压')
    P008 = Column(Float(8), comment='化成工步结束电流')
    P009 = Column(Float(8), comment='化成工步结束容量')
    P010 = Column(Float(8), comment='化成工步结束压力')
    P011 = Column(Float(8), comment='化成工步结束温度')
...
class C303(Base):
    ...
    P003 = Column(Float(8), comment='电压')
...
class C305(Base):
    ...
    P004 = Column(Integer, comment='测试次数')
    P005 = Column(DateTime, index=True, comment='测试时间')
    P006 = Column(Float(8), comment='老化压降')
    P007 = Column(VARCHAR(24), comment='批次号')
...
class C306(Base):
    ...
    P002 = Column(Float(8), comment='注液前称重\\r\\n')
    P003 = Column(Float(8), comment='注液量')
    P004 = Column(Float(8), comment='注液后称重\\r\\n')
    P005 = Column(Float(8), comment='Degas前称重重量')
    P006 = Column(Integer, comment='电芯上料框位置')
    P007 = Column(Float(8), comment='封印厚度1\\r\\n')
    P008 = Column(Float(8), comment='封印厚度2')
    P009 = Column(Float(8), comment='封印厚度3')
    P010 = Column(Float(8), comment='封印厚度4')
    P011 = Column(Float(8), comment='封印厚度5')
    P012 = Column(Float(8), comment='封印厚度6')
    P013 = Column(Float(8), comment='正极侧边电压值')
    P014 = Column(Float(8), comment='正极侧边电阻值')
    P015 = Column(Float(8), comment='负极侧边电压值')
    P016 = Column(Float(8), comment='负极侧边电阻值')
    P017 = Column(VARCHAR(24), comment='腔体号')
    P018 = Column(Float(8), comment='腔体左封头温度')
    P019 = Column(Float(8), comment='腔体右封头温度')
    P020 = Column(Float(8), comment='腔体夹板压力')
    P021 = Column(Float(8), comment='腔体封头压力')
    P022 = Column(Float(8), comment='腔体封印时间\\r\\n')
    P023 = Column(Float(8), comment='腔体封装时真空值')
    P024 = Column(Float(8), comment='腔体保压时间')
    P025 = Column(VARCHAR(24), comment='精封封头编号')
    P026 = Column(Float(8), comment='精封左封头温度')
    P027 = Column(Float(8), comment='精封右封头温度')
    P028 = Column(Float(8), comment='精封封头压力')
    P029 = Column(Float(8), comment='精封封印时间')
    P030 = Column(VARCHAR(24), comment='出站料框码')
    P031 = Column(Integer, comment='出料框内电芯位置')
    P032 = Column(Float(8), comment='Degas后称重重量')
    P033 = Column(Float(8), comment='电芯保液量')
    P034 = Column(Float(8), comment='电芯失液量')
...
class C307(Base):
    ...
    P005 = Column(Float(8), comment='分容工步开始电压')
    P006 = Column(Float(8), comment='分容工步结束电压')
    P007 = Column(Float(8), comment='分容工步结束电流')
    P008 = Column(Float(8), comment='分容工步结束容量')
    P009 = Column(VARCHAR(24), comment='分容工步时间')
    P010 = Column(Float(8), comment='分容工步结束温度')
    P011 = Column(DateTime, comment='分容工步开始时间')
    P012 = Column(DateTime, comment='分容工步结束时间')
    P013 = Column(Float(8), comment='分容容量')
...
class C308(Base):
    ...
    P004 = Column(Float(8), comment='静置库位温度')
...
class C309(Base):
    ...
    P002 = Column(Float(8), comment='电压')
    P003 = Column(Float(8), comment='内阻')
...
class C311(Base):
    ...
    P005 = Column(DateTime, index=True, comment='测试时间')
    P006 = Column(Integer, comment='位置号')
    P007 = Column(Float(8), comment='K1')
    P008 = Column(VARCHAR(24), comment='批次号')
    mark = Column(VARCHAR(255), server_default=text("'正常电芯'"), comment='标记')
    status = Column(CHAR(1), server_default=text("'0'"), comment='电芯状态（0表示良品，1表示不良品，2表示报废品）')
    tombstone = Column(CHAR(1), server_default=text("'0'"), comment='逻辑删除字段（0表示正常，1表示删除）')
...
class C313(Base):
    ...
    P006 = Column(Integer, comment='位置号')
    P007 = Column(Float(8), comment='K1')
    P008 = Column(Float(8), comment='K2')
...
class C314(Base):
    ...
    id = Column(BigInteger, primary_key=True)
    bar_code = Column(VARCHAR(24), nullable=False, index=True, comment='电芯条码')
    P001 = Column(Float(8), comment='电流大小')
    P002 = Column(Float(8), comment='放电时间')
    P003 = Column(VARCHAR(24), comment='托盘条码')
    P004 = Column(DateTime, index=True, comment='测试时间')
    P005 = Column(Float(8), comment='直流内阻值')
    P006 = Column(Float(8), comment='放电前电压')
    P007 = Column(Float(8), comment='放电后电压')
...
class C315(Base):
    ...
    P001 = Column(VARCHAR(24), comment='托盘条码')
    P002 = Column(Integer, comment='位置')
    P003 = Column(Float(8), comment='电芯厚度')
    P004 = Column(Float(8), comment='正极边电压')
    P005 = Column(Float(8), comment='负极边电压')
    P006 = Column(VARCHAR(24), comment='电芯厚度测试工位号')
    P007 = Column(VARCHAR(24), comment='绝缘电压测试工位号')
    P008 = Column(VARCHAR(24), comment='二折工位号')
    P009 = Column(Float(8), comment='预热温度')
    P010 = Column(Float(8), comment='预烫时间')
...
class TotalP64d(Base):
    __tablename__ = 'total_p64d'
    __table_args__ = {'comment': 'p64电芯总表'}

    bar_code = Column(VARCHAR(24), primary_key=True, comment='电芯条码')
    formation_capacity = Column(Float(8), comment='化成充电容量')
    grading_first = Column(Float(8), comment='分容第一次充电容量')
    grading_capacity = Column(Float(8), comment='分容放电容量')
    first_effect = Column(Float(8), comment='首效')
    voltage_first = Column(Float(8), comment='电压测试1')
    voltage_two = Column(Float(8), comment='电压测试2')
    pressure_drop = Column(Float(8), comment='老化压降')
    edge_voltage = Column(Float(8), comment='正极边电压')
    edge_resistance = Column(Float(8), comment='负极边电阻')
    weight = Column(Float(8), comment='电芯重量')
    Infusion_electrolyte = Column(Float(8), comment='注液量')
    keep_electrolyte = Column(Float(8), comment='保液量')
    keep_electrolyte_coefficient = Column(Float(8), comment='保液系数')
    OCV1 = Column(Float(8))
    ACIR1 = Column(Float(8))
    OCV2 = Column(Float(8))
    ACIR2 = Column(Float(8))
    OCV3 = Column(Float(8))
    ACIR3 = Column(Float(8))
    DCIR = Column(Float(8))
    K1 = Column(Float(8))
    K2 = Column(Float(8))
    K3 = Column(Float(8))
    thickness = Column(Float(8), comment='电芯厚度')
    mark = Column(VARCHAR(255), server_default=text("'正常电芯'"), comment='标记')
    status = Column(CHAR(1), server_default=text("'0'"), comment='电芯状态（0表示良品，1表示不良品，2表示报废品）')
    tombstone = Column(CHAR(1), server_default=text("'0'"), comment='逻辑删除字段（0表示正常，1表示删除）')


class TotalP75c(Base):
    __tablename__ = 'total_p75c'
    __table_args__ = {'comment': 'p75电芯总表'}
...
class TransitRecordP64d(Base):
    __tablename__ = 'transit_record_p64d'
    __table_args__ = {'comment': '电芯过站记录表'}

    id = Column(BigInteger, primary_key=True)
    bar_code = Column(VARCHAR(24), nullable=False, comment='电芯条码')
    process_code = Column(VARCHAR(24), comment='工序代码')
    enter_time = Column(DateTime, comment='入站时间')
    leave_time = Column(DateTime, comment='出站时间')
    tombstone = Column(CHAR(1), server_default=text("'0'"), comment='逻辑删除字段（0表示正常，1表示删除）')


class TransitRecordP75c(Base):
    __tablename__ = 'transit_record_p75c'
    __table_args__ = {'comment': '电芯过站记录表'}
